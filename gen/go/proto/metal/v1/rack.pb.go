...
// 	protoc        (unknown)
// source: proto/metal/v1/rack.proto
...
func (x *CreateRackRequest) Reset() {
	*x = CreateRackRequest{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[0]
...
func (x *ReadRacksRequest) Reset() {
	*x = ReadRacksRequest{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x case_ReadRacksRequest_Rack) String() string {
	md := file_proto_metal_v1_rack_proto_msgTypes[1].Descriptor()
	if x == 0 {
		return "not set"
	}
...
func (x *ReadRacksResponse) Reset() {
	*x = ReadRacksResponse{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type UpdateRackRequest struct {
	...
	xxx_hidden_Zone        *string                   `protobuf:"bytes,1,opt,name=zone"`
	xxx_hidden_Name        *string                   `protobuf:"bytes,2,opt,name=name"`
	xxx_hidden_Fields      *UpdateRackRequest_Fields `protobuf:"bytes,3,opt,name=fields"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *UpdateRackRequest) Reset() {
	*x = UpdateRackRequest{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DeleteRacksRequest) Reset() {
	*x = DeleteRacksRequest{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x case_DeleteRacksRequest_Rack) String() string {
	md := file_proto_metal_v1_rack_proto_msgTypes[4].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
type CreateRackAttrRequest struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Zone        *string                `protobuf:"bytes,1,opt,name=zone"`
	xxx_hidden_Rack        *string                `protobuf:"bytes,2,opt,name=rack"`
...
func (x *CreateRackAttrRequest) Reset() {
	*x = CreateRackAttrRequest{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ReadRackAttrsRequest) Reset() {
	*x = ReadRackAttrsRequest{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x case_ReadRackAttrsRequest_Attr) String() string {
	md := file_proto_metal_v1_rack_proto_msgTypes[6].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
func (x *ReadRackAttrsResponse) Reset() {
	*x = ReadRackAttrsResponse{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type UpdateRackAttrRequest struct {
	...
	xxx_hidden_Rack        *string                       `protobuf:"bytes,2,opt,name=rack"`
	xxx_hidden_Name        *string                       `protobuf:"bytes,3,opt,name=name"`
	xxx_hidden_Fields      *UpdateRackAttrRequest_Fields `protobuf:"bytes,4,opt,name=fields"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *UpdateRackAttrRequest) Reset() {
	*x = UpdateRackAttrRequest{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DeleteRackAttrsRequest) Reset() {
	*x = DeleteRackAttrsRequest{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x case_DeleteRackAttrsRequest_Attr) String() string {
	md := file_proto_metal_v1_rack_proto_msgTypes[9].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
func (x *UpdateRackRequest_Fields) Reset() {
	*x = UpdateRackRequest_Fields{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UpdateRackAttrRequest_Fields) Reset() {
	*x = UpdateRackAttrRequest_Fields{}
	mi := &file_proto_metal_v1_rack_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_proto_metal_v1_rack_proto protoreflect.FileDescriptor

const file_proto_metal_v1_rack_proto_rawDesc = "" +
	"\n" +
	"\x19proto/metal/v1/rack.proto\x12\x0eproto.metal.v1\x1a!google/protobuf/go_features.proto\";\n" +
	"\x11CreateRackRequest\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"Z\n" +
	"\x10ReadRacksRequest\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x14\n" +
	"\x04name\x18\x02 \x01(\tH\x00R\x04name\x12\x14\n" +
	"\x04glob\x18\x03 \x01(\tH\x00R\x04globB\x06\n" +
	"\x04rack\";\n" +
	"\x11ReadRacksResponse\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"\x9b\x01\n" +
	"\x11UpdateRackRequest\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12@\n" +
	"\x06fields\x18\x03 \x01(\v2(.proto.metal.v1.UpdateRackRequest.FieldsR\x06fields\x1a\x1c\n" +
	"\x06Fields\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\\\n" +
	"\x12DeleteRacksRequest\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x14\n" +
	"\x04name\x18\x02 \x01(\tH\x00R\x04name\x12\x14\n" +
	"\x04glob\x18\x03 \x01(\tH\x00R\x04globB\x06\n" +
	"\x04rack\"S\n" +
	"\x15CreateRackAttrRequest\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x12\n" +
	"\x04rack\x18\x02 \x01(\tR\x04rack\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\"r\n" +
	"\x14ReadRackAttrsRequest\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x12\n" +
	"\x04rack\x18\x02 \x01(\tR\x04rack\x12\x14\n" +
	"\x04name\x18\x03 \x01(\tH\x00R\x04name\x12\x14\n" +
	"\x04glob\x18\x04 \x01(\tH\x00R\x04globB\x06\n" +
	"\x04attr\"\x87\x01\n" +
	"\x15ReadRackAttrsResponse\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x12\n" +
	"\x04rack\x18\x02 \x01(\tR\x04rack\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x04 \x01(\tR\x05value\x12\x1c\n" +
	"\tprotected\x18\x05 \x01(\bR\tprotected\"\xeb\x01\n" +
	"\x15UpdateRackAttrRequest\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x12\n" +
	"\x04rack\x18\x02 \x01(\tR\x04rack\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12D\n" +
	"\x06fields\x18\x04 \x01(\v2,.proto.metal.v1.UpdateRackAttrRequest.FieldsR\x06fields\x1aP\n" +
	"\x06Fields\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12\x1c\n" +
	"\tprotected\x18\x03 \x01(\bR\tprotected\"t\n" +
	"\x16DeleteRackAttrsRequest\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x12\n" +
	"\x04rack\x18\x02 \x01(\tR\x04rack\x12\x14\n" +
	"\x04name\x18\x03 \x01(\tH\x00R\x04name\x12\x14\n" +
	"\x04glob\x18\x04 \x01(\tH\x00R\x04globB\x06\n" +
...
var file_proto_metal_v1_rack_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_proto_metal_v1_rack_proto_goTypes = []any{
	(*CreateRackRequest)(nil),            // 0: proto.metal.v1.CreateRackRequest
	(*ReadRacksRequest)(nil),             // 1: proto.metal.v1.ReadRacksRequest
	(*ReadRacksResponse)(nil),            // 2: proto.metal.v1.ReadRacksResponse
	(*UpdateRackRequest)(nil),            // 3: proto.metal.v1.UpdateRackRequest
	(*DeleteRacksRequest)(nil),           // 4: proto.metal.v1.DeleteRacksRequest
	(*CreateRackAttrRequest)(nil),        // 5: proto.metal.v1.CreateRackAttrRequest
	(*ReadRackAttrsRequest)(nil),         // 6: proto.metal.v1.ReadRackAttrsRequest
	(*ReadRackAttrsResponse)(nil),        // 7: proto.metal.v1.ReadRackAttrsResponse
	(*UpdateRackAttrRequest)(nil),        // 8: proto.metal.v1.UpdateRackAttrRequest
	(*DeleteRackAttrsRequest)(nil),       // 9: proto.metal.v1.DeleteRackAttrsRequest
	(*UpdateRackRequest_Fields)(nil),     // 10: proto.metal.v1.UpdateRackRequest.Fields
	(*UpdateRackAttrRequest_Fields)(nil), // 11: proto.metal.v1.UpdateRackAttrRequest.Fields
}
var file_proto_metal_v1_rack_proto_depIdxs = []int32{
	10, // 0: proto.metal.v1.UpdateRackRequest.fields:type_name -> proto.metal.v1.UpdateRackRequest.Fields
	11, // 1: proto.metal.v1.UpdateRackAttrRequest.fields:type_name -> proto.metal.v1.UpdateRackAttrRequest.Fields
...
func init() { file_proto_metal_v1_rack_proto_init() }
func file_proto_metal_v1_rack_proto_init() {
	if File_proto_metal_v1_rack_proto != nil {
		return
	}
	file_proto_metal_v1_rack_proto_msgTypes[1].OneofWrappers = []any{
		(*readRacksRequest_Name)(nil),
		(*readRacksRequest_Glob)(nil),
	}
	file_proto_metal_v1_rack_proto_msgTypes[4].OneofWrappers = []any{
		(*deleteRacksRequest_Name)(nil),
		(*deleteRacksRequest_Glob)(nil),
	}
	file_proto_metal_v1_rack_proto_msgTypes[6].OneofWrappers = []any{
		(*readRackAttrsRequest_Name)(nil),
		(*readRackAttrsRequest_Glob)(nil),
	}
	file_proto_metal_v1_rack_proto_msgTypes[9].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_metal_v1_rack_proto_rawDesc), len(file_proto_metal_v1_rack_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_metal_v1_rack_proto_goTypes,
		DependencyIndexes: file_proto_metal_v1_rack_proto_depIdxs,
		MessageInfos:      file_proto_metal_v1_rack_proto_msgTypes,
	}.Build()
	File_proto_metal_v1_rack_proto = out.File
	file_proto_metal_v1_rack_proto_goTypes = nil
	file_proto_metal_v1_rack_proto_depIdxs = nil
}
