...
const file_proto_metal_v1_schema_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/metal/v1/schema.proto\x12\x0eproto.metal.v1\x1a!google/protobuf/go_features.proto\x1a\x1aproto/metal/v1/enums.proto\"N\n" +
	"\x13CreateSchemaRequest\x12.\n" +
	"\x06schema\x18\x01 \x01(\v2\x16.proto.metal.v1.SchemaR\x06schema:\ab\x05\xd2>\x02\x10\x03\"^\n" +
	"\x11ReadSchemaRequest\x12\x12\n" +
	"\x04zone\x18\x01 \x01(\tR\x04zone\x12\x18\n" +
	"\acluster\x18\x02 \x01(\tR\acluster\x12\x12\n" +
	"\x04host\x18\x03 \x01(\tR\x04host:\ab\x05\xd2>\x02\x10\x03\"M\n" +
	"\x12ReadSchemaResponse\x12.\n" +
	"\x06schema\x18\x01 \x01(\v2\x16.proto.metal.v1.SchemaR\x06schema:\ab\x05\xd2>\x02\x10\x03\"\xcc\x02\n" +
	"\x06Schema\x12F\n" +
	"\n" +
	"attributes\x18\x01 \x03(\v2&.proto.metal.v1.Schema.AttributesEntryR\n" +
	"attributes\x12*\n" +
	"\x05makes\x18\x02 \x03(\v2\x14.proto.metal.v1.MakeR\x05makes\x12*\n" +
	"\x05zones\x18\x03 \x03(\v2\x14.proto.metal.v1.ZoneR\x05zones\x124\n" +
	"\bsoftware\x18\x04 \x03(\v2\x18.proto.metal.v1.SoftwareR\bsoftware\x12-\n" +
	...
	"\akey_url\x18\x04 \x01(\tR\x06keyUrl\x12\"\n" +
	"\farchitecture\x18\x05 \x01(\tR\farchitecture\"\x8c\x01\n" +
	"\x05Stack\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x17\n" +
	"\aos_name\x18\x02 \x01(\tR\x06osName\x12\x1b\n" +
	"\tos_flavor\x18\x03 \x01(\tR\bosFlavor\x12\x1d\n" +
	"\n" +
	"os_version\x18\x04 \x01(\tR\tosVersion\x12\x1a\n" +
	"\bsoftware\x18\x05 \x03(\tR\bsoftware\"I\n" +
	"\x04Make\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12-\n" +
	"\x06models\x18\x02 \x03(\v2\x15.proto.metal.v1.ModelR\x06models\"\xc5\x01\n" +
	"\x05Model\x12E\n" +
	"\n" +
	"attributes\x18\x01 \x03(\v2%.proto.metal.v1.Model.AttributesEntryR\n" +
	"attributes\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\"\n" +
	"\farchitecture\x18\x03 \x01(\tR\farchitecture\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xfa\x03\n" +
	"\x04Zone\x12D\n" +
	"\n" +
	"attributes\x18\x01 \x03(\v2$.proto.metal.v1.Zone.AttributesEntryR\n" +
	"attributes\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1b\n" +
	"\ttime_zone\x18\x03 \x01(\tR\btimeZone\x123\n" +
	"\bnetworks\x18\x04 \x03(\v2\x17.proto.metal.v1.NetworkR\bnetworks\x129\n" +
	"\n" +
	"appliances\x18\x05 \x03(\v2\x19.proto.metal.v1.ApplianceR\n" +
	"appliances\x12?\n" +
	"\fenvironments\x18\x06 \x03(\v2\x1b.proto.metal.v1.EnvironmentR\fenvironments\x12*\n" +
	"\x05racks\x18\a \x03(\v2\x14.proto.metal.v1.RackR\x05racks\x12*\n" +
	"\x05hosts\x18\b \x03(\v2\x14.proto.metal.v1.HostR\x05hosts\x123\n" +
	...
	"\x03pxe\x18\x06 \x01(\bR\x03pxe\x12\x1e\n" +
	"\n" +
	"management\x18\a \x01(\bR\n" +
	"management\x12\x12\n" +
	...
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B2Z0github.com/endobit/gen/go/proto/metal/v1;metalv1b\beditionsp\xe8\a"
